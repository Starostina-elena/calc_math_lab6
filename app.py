...
from utils.eiler import eiler
from utils.runge_cutt import runge_cutt
    ...
    if form.validate_on_submit():
        try:
            ...
            return render_template('result.html', adams_points=adams_points,
                                   ...
                                   desmos_C_min = -50 * desmos_C(form.x0.data, form.y0.data),
                                   desmos_C_max = 50 * desmos_C(form.x0.data, form.y0.data),
                                   )
